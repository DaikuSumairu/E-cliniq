...
class MedicalExamController extends Controller
{
    ...
    public function update(Request $request, MedicalExam $medical_exam)
    {
        ...
        // Create Medical Exam
        $medical_exam->update($medicalExamData);
        ...
        $pastMedicalHistory = $medical_exam->past_medical_history;

        // Update Past Medical History
        $pastMedicalHistory->update($pastMedicalHistoryData);
        ...
        $familyHistory = $medical_exam->family_history;

        // Update Family History
        $familyHistory->update($familyHistoryData);
        ...
        $personalAndSocialHis = $medical_exam->personal_and_social_history;
        
        // Update Personal and Social History
        $personalAndSocialHis->update($personalAndSocialHisData);
        ...
        $obGyneHistory = $medical_exam->ob_gyne_history;
        
        // Update OB-GYNE History
        $obGyneHistory->update($obGyneHistoryData);
        ...
        $reviewOfSystem = $medical_exam->review_of_system;
        
        // Update Review of System
        $reviewOfSystem->update($reviewOfSystemData);
        ...
        $physicalExamination = $medical_exam->physical_examination;
        ...
        $MedicalExamResponse = $medical_exam->past_medical_history->medical_exam_response;
        $MedicalExamResponse = $medical_exam->family_history->medical_exam_response;
        $MedicalExamResponse = $medical_exam->ob_gyne_history->medical_exam_response;
        $MedicalExamResponse = $medical_exam->review_of_system->medical_exam_response;
        $MedicalExamResponse = $medical_exam->physical_examination->medical_exam_response;
