        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('student.appointmentStore') }}" onsubmit="return confirm('Are you sure you want to create an appointment?');">
                        @csrf
                                ...
                                <div id="appointment-{{ $appointment->id }}" class="container my-3 border">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col text-right">
                                            <form method="POST" action="{{ route('student.appointmentDestroy', $appointment->id) }}" onsubmit="return confirm('Are you sure you want to decline this appointment?');">
                                                @csrf
                                                @method('DELETE')
