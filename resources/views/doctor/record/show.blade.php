        ...
        <div class="row">
            ...
            <div class="col border">
                ...
                <div id="consultation-content" class="mini-content pt-1">
                            ...
                            <div class="container" style="height: 212px; overflow: auto;">
                                ...
                                <div class="row mx-auto mt-1">
                                    ...
                                    <div class="col text-right">
                                        <a class="btn btn-primary px-4" href="{{ route('doctor.consultationEdit', $record->consultation->id) }}">Update</a>
                                    </div>
                                </div>
                                <div class="row mx-auto mt-1">
                                    <div class="col pt-2">
                    ...
                    @else
                        <div class="text-center">
                            <p>No consultation has been made. <a href="{{ route('doctor.consultationCreate', $record->id) }}">Create now.</a></p>
                        </div>
                    @endif
                </div>
                ...
                <div id="medical-exam-content" class="mini-content pt-1">
                    @if(isset($record->medical_exam))
                        ...
                        <div class="container" style="height: 212px; overflow: auto;">
                            <div class="row mx-auto mt-1">
                                ...
                                <div class="col text-right">
                                    <a class="btn btn-primary px-4" href="{{ route('doctor.medExamEdit', $record->medical_exam->id) }}">Update</a>
                                </div>
                            </div>
                    ...
                    @else
                        <div class="text-center">
                            <p>No medical exam has been made. <a href="{{ route('doctor.medExamCreate', $record->id) }}">Create now.</a></p>
                        </div>
                    @endif
                </div>
