            ...
            <div class="row">
                ...
                <div class="col border">
                    ...
                    <div id="consultation-content" class="mini-content pt-1">
                        ...
                        @else
                            <div class="text-center">
                                <p>No consultation has been made. Plese go to the clinic office to have one</p>
                            </div>
                        @endif
                    </div>
                    ...
                    <div id="medical-exam-content" class="mini-content pt-1">
                        ...
                        @else
                            <div class="text-center">
                                <p>No medical exam has been made. Plese go to the clinic office to have one</p>
                            </div>
                        @endif
                    </div>
                    ...
                    <div id="dental-exam-content" class="mini-content pt-1">
                        ...
                        @else
                            <div class="text-center">
                                <p>No dental exam has been made. Plese go to the clinic office to have one</p>
                            </div>
                        @endif
                    </div>
                </div>
