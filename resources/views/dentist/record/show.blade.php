...
@section('content')
    <div class="position-relative">
        ...
        <div class="position-left">
            <a class="btn btn-primary" href="{{ route('dentist.recordIndex') }}">Go Back</a>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col border">
                ...
                <div id="dental-exam-content" class="mini-content pt-1">
                        ...
                        @if(isset($record) && !empty($record))
                            ...
                            <div class="row">
                                ...
                                <div class="col text-right">
                                    <a class="btn btn-primary px-4" href="{{ route('dentist.dentalExamEdit', $record->dental_exam->id) }}">Update</a>
                                </div>
                            </div>
                    ...
                    @else
                        <div class="text-center">
                            <p>No dental exam has been made. <a href="{{ route('dentist.dentalExamCreate', $record->id) }}">Create now.</a></p>
                        </div>
                    @endif
                </div>
            </div>
